import { Tailwind, Html, Container, Heading, Text, Button } from '@react-email/components';
      ...
      <Html className='font-helvetica'>
        <Container>
          ...
          <Text className='m-0 mt-4 mb-8'>
            ...
            <span className="font-semibold"> Budmin</span>. Verifica tu cuenta haciendo en el siguiente botón.
          </Text>
